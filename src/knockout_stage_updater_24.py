...
parser = argparse.ArgumentParser(description='Update knock-out stage bracket with team names.', usage='{} <file_name> <list_of_replacements>'.format(os.path.basename(__file__)))
